...
namespace Effects
{
	public partial class TestPage : ContentPage
	{
		...
		void ApplyPreset(Preset preset)
		{
			...
			/*colorPicker5.Color = preset.CalendarBackground;
			colorPicker9.Color = preset.CalendarBorder;
			colorPicker7.Color = preset.ItemBorder;
			colorPicker6.Color = preset.ItemBackground1;
			checkBox6.Checked = preset.UseItemBackground2;
			colorPicker8.Color = preset.ItemBackground2;*/
