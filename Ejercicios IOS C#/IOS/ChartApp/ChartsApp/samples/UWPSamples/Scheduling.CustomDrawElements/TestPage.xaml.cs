...
namespace CustomDrawElements
{
	public partial class TestPage : ContentPage
	{
		public TestPage()
		{
			...
			calendar.ResourceViewSettings.ViewStyle = ResourceViewStyle.Lanes;
			calendar.ResourceViewSettings.MiddleTimelineSettings.Unit = TimeUnit.Day;
			calendar.ResourceViewSettings.MiddleTimelineSettings.Format = "dd ddd";
			calendar.ResourceViewSettings.BottomTimelineSettings.Unit = TimeUnit.Hour;
			calendar.ResourceViewSettings.BottomTimelineSettings.Format = "HH";
		...
		void OnItemSelected(object sender, SelectedItemChangedEventArgs e)
		{
			...
			switch (selected)
			{
				...
				case MindFusion.Scheduling.CustomDrawElements.WeekRangeHeader:
				case MindFusion.Scheduling.CustomDrawElements.WeekRangeSubHeader:
				case MindFusion.Scheduling.CustomDrawElements.WeekRangeSubHeaderCell:
				case MindFusion.Scheduling.CustomDrawElements.WeekRangeResourceHeader:
					calendar.CurrentView = CalendarView.WeekRange;
					break;

				case MindFusion.Scheduling.CustomDrawElements.ResourceViewCell:
				case MindFusion.Scheduling.CustomDrawElements.ResourceViewItem:
				case MindFusion.Scheduling.CustomDrawElements.ResourceViewTimeline:
				case MindFusion.Scheduling.CustomDrawElements.ResourceViewRowHeader:
				case MindFusion.Scheduling.CustomDrawElements.ResourceViewSelection:
				case MindFusion.Scheduling.CustomDrawElements.ResourceViewCellComplete:
				case MindFusion.Scheduling.CustomDrawElements.ResourceViewTimelineCell:
					calendar.CurrentView = CalendarView.ResourceView;
					break;
