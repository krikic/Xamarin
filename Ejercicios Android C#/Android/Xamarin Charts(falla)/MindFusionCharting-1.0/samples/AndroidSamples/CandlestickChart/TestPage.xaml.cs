...
namespace CandlestickChart
{
    public partial class TestPage : ContentPage
    {
        public TestPage()
        {
            ...
            // series style
            candlestickChart.CandlestickWidth = 4;
        ...
        void cbDateFormat_ItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ((MyStockSeries)candlestickChart.Series[0]).CustomDateTimeFormat = cbDateFormat.SelectedItem.ToString();
        }
