...
<center><h1>Bienvenido a la Web<h1></center>
            
<br>
<br>
<p>What do you think about freebies? Do you consider them as cheap and middling 
quality solutions that can be used for average or small business websites? This 
assumption is partially true and we are going to show you that freebies can be 
not only catchy but also professionally done.
</p>
<p>
All free website templates that we present you every week are developed taking 
into consideration all the demands of your future projects and they make it easier 
to create the one you wish. Today we launch another freebie.
</p>
<p>
It can be undoubtedly helpful for those who want to create the online web presence
 and share their business experience with others. Not only premium templates can 
 feature top-notch characteristics, free website templates can also be the examples
  of thought-out work of professional designers. They are considered to be  a 
  wonderful opportunity to try your skills and make something great without extra costs.
  </p>
  <br>
  <br>
  <center>
  <img src="img/tienda.jpg" alt="Smiley face" height="300" width="500">
  </center>
