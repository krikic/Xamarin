...
<div data-role="page" id="main_page" data-theme="a">
    ...
    <div style="max-width: 50%; margin-left: 25%;">
        ...
        <a id="search_btn" href="#" data-role="button" style="top: -28px;width: 20%;margin: -14px;left: 103%;">Buscar</a>
    </div>
    
    <div style="float: right; top: -57px; position: relative;">
        
        <img src="../img/cesta.gif" alt="" width="40px" style="padding: 5px"
             /><span class="badge" style="display: inline-block;">0
</span>
...
<div data-role="content">
    ...
    <center><h4>Bienvenidos a la tienda.</h4></center>
