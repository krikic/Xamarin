<!-- Para crear foro y tema,y borrarlos hay entrar al panel 
y hay que iniciar sesión como 
administrador el usuario es admin y la clave 123456. -->
<?php
//Include las clases
            ...
            <div class="foro">
                ...
                <div class="ultimocomentario">
                    ...
                    if (sizeof($mensaje) > 0) {
                        ...
                        echo "por: " . $mensaje[0]["username"] . "<br/>";
...
<div class="caja">
    ...
    <div class="foro">
        <?php
        // listo todos los usuarios cosa de niñorequire_once 'class/usuarios.php';
        $obju = new Usuarios();
        $usuarios = $obju->usuarios();
        foreach ($usuarios as $u) {
            ?>
            <a href="perfil.php?uid=<?php echo $u["uid"]; ?>"><?php echo $u["username"]; ?></a>
            <?php
        }
        ?>
    </div>
